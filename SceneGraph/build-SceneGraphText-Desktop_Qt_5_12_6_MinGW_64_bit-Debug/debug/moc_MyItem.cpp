...
#include "../../SceneGraphText/MyItem.h"
...
QT_MOC_LITERAL(3, 21, 21), // "alternateColorChanged"
QT_MOC_LITERAL(4, 43, 5), // "color"
QT_MOC_LITERAL(5, 49, 14) // "alternateColor"

    },
    "MyItem\0colorChanged\0\0alternateColorChanged\0"
    "color\0alternateColor"
};
...
void MyItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MyItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyItem::colorChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyItem::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyItem::alternateColorChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyItem::colorChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyItem::alternateColorChanged()
{
